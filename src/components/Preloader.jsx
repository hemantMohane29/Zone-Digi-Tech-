...
export default function Preloader({ onLoadingComplete }) {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex flex-col items-center justify-center bg-stone-50 dark:bg-[#0a0a0f] transition-opacity duration-500 ease-in-out ${isFading ? 'opacity-0 pointer-events-none' : 'opacity-100'
        }`}
    >
      <div className="relative flex flex-col items-center">
        ...
        {/* Logo/Icon */}
        <div className="relative flex items-center justify-center w-20 h-20 mb-4 animate-bounce">
          <img src="/URL_LOGO.png" alt="Zone Digi Tech logo" className="w-16 h-16 object-contain" />
        </div>

        {/* Text */}
        <h2 className="text-2xl font-bold tracking-widest text-stone-900 dark:text-white uppercase font-display">
          Zone Digi<span className="text-transparent bg-clip-text bg-gradient-to-r from-saffron-500 to-saffron-400">Tech</span>
        </h2>
